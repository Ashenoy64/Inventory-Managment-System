...
Consumer = rabbitmq_connector.Connector(
    port=Settings.RABBITMQ["PORT"], queue=Settings.RABBITMQ["QUEUE"], host=Settings.RABBITMQ["HOST"])
...
def self_heartbeat():
    while True:
        ...
        Database.upsert(Settings.NODE['ID'], Settings.NODE['NAME'], datetime.datetime.strptime(
